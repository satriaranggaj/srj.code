        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-primary-900 md:border border-primary-700 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-black">
                        <x-row>
                            ...
                            <x-col :col-md="12">
                                <div>
                                    <x-input-label style="color: white;" for="title" value="Judul Project" />
                ...
                <div class="flex flex-wrap items-center justify-end mt-4">
                    @isset($data)
                        <x-danger-button type="button" data-toggle="delete-button" href="{{ route('project.destroy', $data->id) }}" class="mr-auto">
                            Hapus
                        </x-danger-button>
                    @endisset

                    <x-back-button as="a" href="{{ route('project.index') }}" class="">
                        Batal
                    </x-back-button>
