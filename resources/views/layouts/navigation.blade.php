        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('skill.index')" :active="request()->routeIs('skill.index', 'skill.edit', 'skill.create')">
                        {{ __('Skill') }}
                    </x-nav-link>
                    <x-nav-link :href="route('project.index')" :active="request()->routeIs('project.index', 'project.edit', 'project.create')">
                        {{ __('Project') }}
                    </x-nav-link>
